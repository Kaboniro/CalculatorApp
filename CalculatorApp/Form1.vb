...
Imports MathNet.Symbolics.Integration
...
Public Class Form1
    ...
    Private Sub btn_intergrate_Click(sender As Object, e As EventArgs) Handles btn_intergrate.Click
        Dim expression As String = input_box.Text
        Dim integralResult As String = IntegrateExpression(expression)
        result_box.Text = integralResult
    End Sub
    Private Function IntegrateExpression(expression As String) As String
